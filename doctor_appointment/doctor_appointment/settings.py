...
DEFAULT_FROM_EMAIL = os.getenv('EMAIL_HOST_USER')  # Default from email address

# Ensure Django is aware of the settings
...
SECRET_KEY = 'django-insecure-+swn5b-)i(b9d!a^ziww1cbro8@jb&w+q1d)#rncziwk)_n!gk'
